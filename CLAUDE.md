...
### 2-1. 관심 종목 유니버스 (13섹터 ≈ 80종목)

초기 5섹터 × 10종목 = 50종목으로 시작했으나, 2026-06-18 paper bot 진단에서
76%의 신호가 CAUTION/RISK 였고 STRONG_BUY가 0건이었음 — 보유 종목이 3/10에
머문 직접 원인이 "유니버스가 너무 좁아 약세 섹터만 본다"는 결론.
Phase B 확장으로 8개 섹터를 추가 (마이그레이션 40).
...
| 조선 | HD현대중공업(329180), 한화오션(042660), 삼성중공업(010140) |
| 방위산업 | 한화에어로스페이스(012450), LIG넥스원(079550), 현대로템(064350), 한국항공우주(047810) |
| 금융 | KB금융(105560), 신한지주(055550), 하나금융지주(086790), 메리츠금융지주(138040) |
| 통신 | SK텔레콤(017670), KT(030200), LG유플러스(032640) |
| 미디어/엔터 | 하이브(352820), JYP Ent.(035900), 에스엠(041510), CJ ENM(035760) |
| 화학/소재 | LG화학(051910), 한화솔루션(009830), 금호석유(011780) |
| 음식료/유통 | CJ제일제당(097950), 이마트(139480), 오리온(271560), BGF리테일(282330) |
| 항공/물류 | 대한항공(003490), HMM(011200), 한진칼(180640), CJ대한통운(000120), 한진(002320) |
...
- 일일 LLM 호출 상한: 320건 (80종목 × 4회) — 2026-06-18 Phase B 확장 반영
- 초과 시 자동 중단 + 알림
